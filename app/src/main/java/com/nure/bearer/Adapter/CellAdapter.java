...
public class CellAdapter extends ArrayAdapter<Cell> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView cellNumber = currentItemView.findViewById(R.id.cellFoodName);
        cellNumber.setText(currentNumberPosition.getNumber());

        TextView cellStatus = currentItemView.findViewById(R.id.cellStatus);
        cellStatus.setText(currentNumberPosition.getStatus());
        ...
        if (!currentNumberPosition.getStatus().equals("EMPTY")) {
            ...
            cellPrice.setText("" + currentNumberPosition.getPrice());
            cellShelfLife.setText(currentNumberPosition.getShelfLife());
            cellFoodName.setText(currentNumberPosition.getFoodName());
            cellWeight.setText(""+currentNumberPosition.getWeight());
        }
